...
func init() {
	...
	if err := DB.AutoMigrate(&models.BookDetail{},&models.FavoriteBook{},&models.BookImage{},&models.BookCategory{}, &models.Category{}, &models.Author{}, &models.Book{}, &models.User{}, &models.Purchase{}, &models.Transaction{}).Error; err != nil {
